...
const generateDate = () => {
  const date = new Date();
  let weekday = ['Chủ nhật', 'Hai', 'Ba', 'Tư', 'Năm', 'Sáu', 'Bảy'];
  let weekdays = [];
  for (let i = 0; i < 7; i++) {
    let tempDate = {
  ...
  const BookSeats = async () => {
    if (
      ...
      ToastAndroid.showWithGravity(
        'Vui lòng chọn ghế , ngày tháng và giờ chiếu',
        ToastAndroid.SHORT,
        ToastAndroid.BOTTOM,
      );
    }
      ...
      <View style={styles.seatContainer}>
        ...
        <View style={styles.seatRadioContainer}>
          ...
          <View style={styles.radioContainer}>
            ...
            />
            <Text style={styles.radioText}>Có người</Text>
          </View>
          <View style={styles.radioContainer}>
            <CustomIcon
              name="radio"
            ...
            />
            <Text style={styles.radioText}>Chọn</Text>
          </View>
        </View>
      </View>
